...
public class Setup
{
	...
	void gameSetup()
	{
		...
		state.snake1 = new P1Snake(headPos, facing, headSize, bodySize, tailSize, "images/s02_heads.png", "images/s2_body.png", "images/s02_tail.png");
		...
		state.snake2 = new P1Snake(headPos, facing, headSize, bodySize, tailSize, "images/s01_heads.png", "images/s1_body.png", "images/s01_tail.png");
